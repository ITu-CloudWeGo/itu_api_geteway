...
require (
	github.com/ITu-CloudWeGo/itu_rpc_auth v0.0.0-20250323135504-75c1e5658093
...
require (
	github.com/ITu-CloudWeGo/itu_rpc_tags v0.0.0-20250325065425-def5d81e8b4f // indirect
